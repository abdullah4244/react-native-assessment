        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
              <View style={[GlobalStyles.mt_2]}>
                <Input
                  ...
                  onChangeText={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
                      email: { value: e, errorMsg: '', isValid: true },
                    }));
                  }}
              ...
              <View style={[GlobalStyles.mt_2]}>
                <Input
                  ...
                  onChangeText={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
                      password: { ...prevState.password, value: e },
                    }));
                  }}
                  error={!formState.password.isValid}
                  errorMsg={formState.password.errorMsg}
                  secureTextEntry={isToggleEye ? true : false}
                  PostFix={
                    <Pressable
                      onPress={() => {
                        setIsToggleEye((prev) => !prev);
                      }}
                    >
              ...
              <View style={[GlobalStyles.mt_1]}>
                <Text style={styles.secondaryText}>
                  By clicking “Log in”, you agree to receive SMS text messages from Chime to verify
                  your identity
                </Text>
              </View>
            </View>
            <View style={[GlobalStyles.mt_4, { width: '100%' }]}>
              <PrimaryButton
                disabled={isFetching}
                label={isFetching ? 'Submitting...' : 'Log In'}
                onPress={onSubmit}
              />
            </View>
            <BottomSheet
